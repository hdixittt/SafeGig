...
export default function Claims() {
  ...
  useEffect(() => {
    api.get('/admin/claims').then(r => setClaims(r.data)).catch(() => {
      setClaims([
        { id:'c1', trigger_type:'heavy_rain',       amount:1200, fraud_score:0.08, status:'paid',          initiated_at:'2026-04-03T10:00:00Z', worker_name:'Mayank Sharma', city:'Gurgaon' },
        { id:'c2', trigger_type:'severe_pollution', amount:375,  fraud_score:0.72, status:'manual_review', initiated_at:'2026-04-03T11:30:00Z', worker_name:'Vartika Singh', city:'Chennai' },
        { id:'c3', trigger_type:'extreme_heat',     amount:500,  fraud_score:0.15, status:'approved',      initiated_at:'2026-04-02T14:00:00Z', worker_name:'Rahul Verma',   city:'Delhi'   },
      ]);
    });
  }, []);
